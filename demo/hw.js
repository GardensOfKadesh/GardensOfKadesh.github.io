...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']("/", "Plugscreens", true, true);
   ...
   loadPackage({"files": [{"filename": "/DL_Music.wxd", "start": 0, "end": 7756072}, {"filename": "/DL_demo.vce", "start": 7756072, "end": 35226503}, {"filename": "/HomeworldDL.big", "start": 35226503, "end": 66949754}, {"filename": "/Update.big", "start": 66949754, "end": 67297428}, {"filename": "/HomeworldSDL.big", "start": 67297428, "end": 77333442}, {"filename": "/Plugscreens/r1mothership.jpg", "start": 77333442, "end": 77549292}, {"filename": "/Plugscreens/github-orig.plug", "start": 77549292, "end": 77551482}, {"filename": "/Plugscreens/github.plug", "start": 77551482, "end": 77553821}, {"filename": "/Plugscreens/button-fig-off.jpg", "start": 77553821, "end": 77562130}, {"filename": "/Plugscreens/button-steam-off.jpg", "start": 77562130, "end": 77562884}, {"filename": "/Plugscreens/button-github-off.jpg", "start": 77562884, "end": 77563585}, {"filename": "/Plugscreens/button-fig-on.jpg", "start": 77563585, "end": 77571956}, {"filename": "/Plugscreens/button-discord-on.jpg", "start": 77571956, "end": 77572624}, {"filename": "/Plugscreens/button-steam-on.jpg", "start": 77572624, "end": 77573472}, {"filename": "/Plugscreens/button-discord-off.jpg", "start": 77573472, "end": 77574096}, {"filename": "/Plugscreens/button-github-on.jpg", "start": 77574096, "end": 77574915}, {"filename": "/Plugscreens/github-plug-template.md", "start": 77574915, "end": 77576750}], "remote_package_size": 77576750, "package_uuid": "e10bf7b3-38ab-4c11-9ca7-2bb60b54044c"});
...
var ASM_CONSTS = {
  492956: function() {FS.mkdir('/home/web_user/.homeworld/'); FS.mkdir('/home/web_user/.homeworld/SavedGames/'); FS.mkdir('/home/web_user/.homeworldDownloadable/'); FS.mkdir('/home/web_user/.homeworldDownloadable/SavedGames/'); FS.mkdir('/assets/'); FS.mount(IDBFS, {}, '/home/web_user/.homeworld/SavedGames/'); FS.mount(IDBFS, {}, '/home/web_user/.homeworldDownloadable/SavedGames/'); FS.mount(IDBFS, {}, '/assets/'); FS.symlink('/assets/Homeworld.big', 'Homeworld.big'); FS.symlink('/assets/HW_Comp.vce', 'HW_Comp.vce'); FS.symlink('/assets/HW_Music.wxd', 'HW_Music.wxd'); FS.syncfs(true, function (err) { if (err) console.log("FS.syncfs error " + err); Module._main_postinit(0, 0); });},  
 493623: function() {FS.syncfs(function (err) { });},  
 493654: function($0) {var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL);},  
 493879: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 494016: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 494240: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 494733: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
 ...
 501564: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 501657: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 501726: function() {return screen.width;},  
 501751: function() {return screen.height;},  
 501777: function() {return window.innerWidth;},  
 501807: function() {return window.innerHeight;},  
 501838: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;}
};
